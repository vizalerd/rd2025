import * as THREE from 'three';
    ...
    window.addEventListener('mousemove', function(event) {
        ...
        const bonusQuestions = {
            1: {
                text: "Неожиданно, Ержана подхватывает большая мифическая птица и предлагает подкинуть его до нужного места. Но перед этим, просит помощи - она заблудилась, и не может найти дерево, где ей нужно отложить яйцо. Куда ее направить?",
